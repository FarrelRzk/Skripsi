                ...
                <ul class="nav navbar-toolbar">
                    <li class="dropdown dropdown-user">
                        <a class="nav-link dropdown-toggle link" data-toggle="dropdown">
                            ...
                            </span><i class="fa fa-angle-down m-l-5"></i>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-right" style="min-width: 150px">
                            <a class="dropdown-item" href="<?= base_url('ubah-pass') ?>"><i class="fa fa-lock"></i>Ubah
                                Password</a>
                            <a class="dropdown-item" href="<?= base_url('tambah-user') ?>" <?php if ($username != 'superadmin')
                                  echo 'style="display: none"' ?>><i class="fa fa-user"></i>Tambah
                                  User</a>
